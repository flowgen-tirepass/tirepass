...
from .models import YearAllocation, ShoppingCart, Customers, PaymentMethod, GoodsDisplayName, Brand, BrandPattern, Goods
...
def api_products_erp(request):
    ...
    try:
        ...
        for goods in products_page:
            ...
            # DOT 재고 정보 구성
            # 상품카드: 기본할인+브랜드/패턴할인+고객개별상품할인 (final_discount_rate)
            # 장바구니: 위 3가지 + DOT 할인
            dot_inventory = []
