...
brand_file = r"C:\Users\jmyang\Dropbox\1.0_tirepass\tire_data\static\mobile\img\brands\goodyear.png"
...
try:
    ...
    print(f"[OK] goodyear.png: {original_width}x{original_height} -> {new_width}x{new_height}")
    print("goodyear 로고 크기 조정 완료!")
