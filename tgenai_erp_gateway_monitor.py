"""
TgenAI ERP Gateway 24/7 Monitoring and Auto-Recovery System

Features:
1. Monitor ERP API server status (every minute)
2. Auto-restart ERP API server on failure
3. Monitor PythonAnywhere connection
...
Windows Task Scheduler:
    ...
    - Action: python C:/TgenAI/tgenai_erp_gateway_monitor.py
